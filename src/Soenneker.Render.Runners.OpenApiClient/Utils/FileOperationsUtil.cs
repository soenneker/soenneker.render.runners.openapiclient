...
using Soenneker.Render.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Render.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Render:ClientGenerationUrl"] ?? "https://api-docs.render.com/openapi/render-public-api-1.json";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "RenderOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
